...
samtools view -u $S3 chr6:29886751-33090696 | samtools view -u -L data/hla.bed - > $OUT.bam
bamtools convert -format fastq -in $OUT.bam | sga preprocess -q20 -f5 -m 100 - > $OUT.fq
...
diamond blastx -C 20000 --index-mode 2 --seg no --min-score 10 --top 20 -c 1 -v -d data/hla -q $OUT.fq -a $OUT.daa
